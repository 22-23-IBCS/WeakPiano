...
def main():
    ...
    while True:
        ...
        if option == "1":
            ...
            break #Stops this loop after user says to stand.
        print("")
        print(userHand)
        print("Your hand's value is :" + str(calcHandValue(userHand)))
        print("")
#Need part that compares whether the sum is >= to 21. Busts or not
    print("")
    print("Dealer hand:")
    print(dealerHand) 
    ...
    while True:  #true makes it always true, always repeat loop 
        
        if calcHandValue(dealerHand) < 17: #Automatically hit 1 more card under "<17" condition
            print("Dealer hits!\n")
        ...
        if calcHandValue(dealerHand) > 21:
            print("Dealer bust!")
            break
#Need to also compare sum from user and dealer to see who wins. 
